...
def process_patch(entry, skymap, task):
    ...
    for band in ["g", "r", "i", "z", "y"]:
        ...
        cat = task.anacal.run(**data)
        cat = rfn.repack_fields(cat[colnames])
        del data, seed, res
