...
def process_tract(tract_id, emax_sq, mag_cuts, bright, median, faint):
...
def main():
    ...
    for tract_id in my_entries:
        out = process_tract(tract_id, args.emax ** 2, mag_cuts_local, bright, median, faint)
