...
def process_tract(tract_id, emax_sq, mag_cuts, A_wopt, B_wopt, bright, median, faint):
...
def main():
    ...
    for tract_id in my_entries:
        out = process_tract(tract_id, args.emax ** 2, mag_cuts_local, args.A, args.B, bright, median, faint)
